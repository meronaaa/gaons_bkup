...
<tr>
	...
	<td class="lp10"><input type="text" name="title" class="w500 lbox" value="<?=stripslashes($wData[data][re_title])?>" exp="제목을"/></td>
</tr>
<tr>
...
<tr>
<!-- 	<th class="lp10">내 용</th>	 -->
	<td class="pd10" colspan="2">
		<textarea name="content" class="tbox2" cols="" rows="0" width=""></textarea>
	</td>
</tr>
</tbody>
</table>
