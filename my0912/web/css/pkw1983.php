...
body{margin:0px;padding:0px;font-family:font-family:'NotoSansKR_400',NotoSansKR,'돋움',Dotum,Helvetica,'Apple SD Gothic Neo',Sans-serif;font-size:12px;color:#737373;}
...
#wrap{width:100%;}
#header{width:1000px;height:80px;margin:0 auto;border:1px solid #111;}
...
#footer{width:1000px;height:100%;margin:0 auto;border:1px solid #111;}
...
/** Input Box Style **/
.lbox{font-size:14px; border:1px solid #ccc; height:26px; background-color:#fff; color:#737373;padding-left:5px;}
.sbox{font-size:14px; border:1px solid #ccc; height:26px; background-color:#fff; color:#737373;}
.tbox{font-size:14px; border:1px solid #ccc; background-color:#fff; color:#737373;}
.tbox2 {font-size:14px; border:1px solid #ccc; background-color:#fff; color:#737373;width:100%;min-height:250px;resize:none;}
.vbox{font-size:14px; border:0px solid #ccc; height:26px; background-color:#fff; color:#737373;}
.fbox{font-size:14px; border:1px solid #ccc; height:26px; background-color:#fff; color:#737373;}
...
/**table**/
table.table_a{border-top:2px solid #555;border-spacing:0px;border-collapse:collapse;}
table.table_a tr {border-bottom: 1px solid #ccc;}
table.table_a th{font-size:14px;height:50px;/*background:#f4f4f4*/;color:#565656;vertical-align:middle;font-weight:500;}
table.table_a td{font-size:14px;height:50px;color:#787878;vertical-align:middle;}
table.table_a caption{text-align:left;padding-left:10px;}

/**layout**/
.design_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}

.article_00{width:50%;margin:0px auto;padding-top:10px;padding-top:20px;padding-bottom:20px;}
...
.join_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}

.login_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}

.find_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}

.exit_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}
...
.exit_a{width:50%;margin:0px auto;border-top:3px solid #81B921;border-spacing:1px;}
...
.mypage_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}

.board_list_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}
.board_write_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}
.board_view_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;line-height:20px;}
.board_edit_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}
.board_comment_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}
.board_relate_00{width:50%;margin:0px auto;padding-top:20px;padding-bottom:20px;}
...
.mdl-login .mdl-menu dt a{
	...
	text-align:left;
	color:#fff;
	background:url(<?=$rtnm?>/img/design/bg_bul.png) 142px 50% no-repeat;
}
