...
<div class="join_00">
	...
	<tbody>
	<tr>
		<th class="al"><?=$compulsory?> 회원아이디</th>
		<td class="lp10 pd10">
			<input type="text" name="id" id="id" maxlength="20" class=" lbox w200 bold" style="ime-mode:disabled;" exp="아이디를" tabindex="1" />
	...
	<tr>
		<th class="al"><?=$compulsory?> 비밀번호</th>
		<td class="lp10 pd10">
	...
	<tr>
		<th class="al"><?=$compulsory?> 비밀번호확인</th>
		<td class="lp10 pd10">
	...
	<tr>
		<th class="al"><?=$compulsory?> 이름</th>
		<td class="lp10"><input type="text" name="name" class="lbox w100" exp="이름을" tabindex="4" /></td>
	</tr>
	<tr>
		<th class="al"><?=$compulsory?> 이메일</th>
		<td class="lp10 pd10">
			<input type="text" name="email" class="lbox w400" exp="이메일을" chktype="email" tabindex="5" />
			<br /><span class="msg">※ 이메일에는 반드시 수신가능한 이메일 주소를 입력해 주십시오. <br />나중에 비밀번호 찾기에 사용됩니다.</span>
		</td>
	</tr>
	<tr>
		<th class="al"><?=$compulsory?> 주소</th>
		<td class="pd10 pd10">
			...
			<input type="text" name="adr1" class="lbox w400" readonly /><br /><br />
			<input type="text" name="adr2" class="lbox w400" exp="상세주소를" />
		</td>
	</tr>
	<tr>
		<th class="al"><?=$compulsory?> 휴대전화</th>
		<td class="lp10">
			<input type="text" name="hp1" class="lbox w50" maxlength="3" exp="휴대전화를" chktype="number" /> -
			<input type="text" name="hp2" class="lbox w50" maxlength="4" exp="휴대전화를" chktype="number" /> -
			<input type="text" name="hp3" class="lbox w50" maxlength="4" exp="휴대전화를" chktype="number" />
		</td>
	</tr>
	<tr>
		<th class="al">일반전화</th>
		<td class="lp10">
			<input type="text" name="tel1" class="lbox w50" maxlength="4" /> -
			<input type="text" name="tel2" class="lbox w50" maxlength="4" /> -
			<input type="text" name="tel3" class="lbox w50" maxlength="4" />
		</td>
	</tr>
	</tbody>
	</table>
