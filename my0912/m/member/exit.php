...
<div class="exit_00">
	...
	<div class="tit"><?=$symbolic?> 회원탈퇴 ( <?=$compulsory?> 표시는 필수입력사항입니다. )</div>
	...
	<tr>
		...
		<td class="pd10"><textarea wrap="physical" cols="70" style='width:80%;' rows="20" name="exitmemo" class="tbox" exp="탈퇴사유를"></textarea></td>
	</tr>
	</table>
